...
$total_tagihan =($harga_per_meter * $jumlah_pemakaian) - $denda;
    ...
    <div class="box-kwitansi" id="box-kwitansi">
        <center><img src="imgs/logo2.png" alt="logo_perusahaan" width="75">
        <h2>PT SINAR NUSANTARA BERSAMA</h2>
        <h5>Kwitansi Pembayaran Listrik Pascabayar</h5></center>
        ...
        <table width="80%" align="center" cellpadding="5">
            ...
            <tr>
                <td>RP Tagihan </td>
                <td colspan="3">:<?php echo  $_POST['jumlah_pemakaian'];?></td>
            </tr>
            <tr>
                <td>No Ref</td>
